...
alter table Food add column foodImage varchar(50);
alter table Food modify foodImage blob;
...
/*Create table admin*/
create table Admin(adminUserName varchar(50), adminPassword varchar(50));
